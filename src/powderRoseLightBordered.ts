...
const ui = {
    ...
    minimap_bg: e`fcf8f8`,             // secondary_bg
    side_bar_bg: u`fcf8f8`,            // secondary_bg
    editor_group_header_bg: u`fcf8f8`, // secondary_bg

    status_bar_bg: u`f8e8e8`, // primary bg
    title_bar_bg: u`f8e8e8`   // primary bg
}
